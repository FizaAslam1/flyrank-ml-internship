...
Negative Result (Valid): Position's near-zero importance is a valid finding — it means ranking alone shouldn't trigger refresh decisions. This contradicts common intuition but is backed by data.
